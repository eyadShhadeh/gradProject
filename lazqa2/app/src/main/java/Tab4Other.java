...
public class Tab4Other extends Fragment {
    ...
    public View onCreateView( LayoutInflater inflater, ViewGroup container,
        ...
        retrieveDataRef = fbase.getReference().child("design").child("others");
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<cardItem, ViewHolder>(options) {
            @Override
            protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull final cardItem model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(getActivity(),OtherDesign.class);
