...
public class OtherDesign extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot dc : dataSnapshot.getChildren()){
                    if(dc.getKey().equals(buyerId)){
                        ...
                        //  Toast.makeText(OtherDesign.this, buyerName+buyerPhone, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.other_types, android.R.layout.simple_spinner_item);
    ...
    private void addCurrentLocation (){
        ...
        if(placeCheck.isChecked()){
            ...
            if (ActivityCompat.checkSelfPermission(OtherDesign.this,
                    android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED &&
                    ActivityCompat.checkSelfPermission(OtherDesign.this,
    ...
    private void startSubmit() {
        ...
        StorageReference filePath = mStorage.child("orders").child("other");
        filePath.child(random()).putFile(ImgUri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                DatabaseReference newDesign = refDatabase.child("other").push();
...
//                }
                ...
                startActivity(new Intent(OtherDesign.this,browsingActivity.class));
                OtherDesign.this.finish();
            }
...
//                }
    ...
    public void init (){
        ...
        btnMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OtherDesign.this,MapActivity.class);
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(OtherDesign.this);
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance()
                    .getErrorDialog(OtherDesign.this,available,ERORR_DIALOG_REQUIST);
            dialog.show();
        }
        else{
